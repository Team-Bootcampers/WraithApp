...
final class POIMiniCardView: UIView {
    ...
    private lazy var containerView: UIView = {
        ...
        view.layer.borderColor = AppTheme.accent.cgColor
    ...
    private lazy var selectionBadgeImageView: UIImageView = {
        ...
        imageView.backgroundColor = AppTheme.accent
    ...
    private func setSelected(_ selected: Bool, animated: Bool) {
        guard animated else {
            ...
            containerView.backgroundColor = selected ? AppTheme.accentSoftBackground : baseBackgroundColor
            return
        }
        ...
        UIView.animate(
            ...
            self.containerView.backgroundColor = selected ? AppTheme.accentSoftBackground : self.baseBackgroundColor
